...
namespace TestareOLX.PageObjects
{
    internal class ListingsPage
    {
        ...
        public IWebElement FirstItem => driver.FindElement(By.XPath("//div[@data-testid='listing-grid']/div[2]/a[@class='css-1bbgabe']"));
        public IWebElement MinPriceInput => driver.FindElement(By.XPath("//input[@data-testid='range-from-input']"));
