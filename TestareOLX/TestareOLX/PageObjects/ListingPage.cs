...
namespace TestareOLX.PageObjects
{
    internal class ListingPage
    {
        ...
        public IWebElement PhoneLabelHidden => driver.FindElement(By.XPath("//h3[@class='css-11hr49z-Text eu5v0x0']"));
        public IWebElement ShowPhoneNumberButton => driver.FindElement(By.XPath("//button[@data-testid='show-phone']"));
        public IWebElement PhoneNumberLabel => driver.FindElement(By.XPath("//a[@data-testid='contact-phone']"));
